...
\section{Diseño}
%\begin{figure}[h]
%	\includegraphics[width=0.95\textwidth]{img/DiagramaClasesDisennoTelnet.eps}
%              \caption{Diagrama de Clases de Diseño para el servicio Telnet}
%	      \label{fig:DiagramaClasesDiseñoTelnet}
%\end{figure}
